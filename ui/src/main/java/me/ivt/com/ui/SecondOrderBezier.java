...
public class SecondOrderBezier extends View {
    ...
    private Paint mPaintAuxiliryText;
    ...
    public SecondOrderBezier(Context context, AttributeSet attrs) {
        ...
        mPaintAuxiliryText = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaintAuxiliryText.setStyle(Paint.Style.STROKE);
        mPaintAuxiliryText.setStrokeWidth(20);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("控制点", mAuxiliaryX, mAuxiliaryY, mPaintAuxiliryText);
        canvas.drawText("起始点", mStartPointX, mStartPointY, mPaintAuxiliryText);
        canvas.drawText("终止点", mEndPointX, mEndPointY, mPaintAuxiliryText);
        //辅助线
